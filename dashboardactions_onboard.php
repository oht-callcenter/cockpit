...
$sqlA = "SELECT * FROM Actions WHERE trkfix_action_cat = 'Onboarding'";
...
while ($actions = mysqli_fetch_array($queryA)) {
    ...
    echo "<a href='#' id='delactionON' class='button tiny alert'>Delete</a>";
...
<script>
    $(document).on('click', '#delactionON', function() {
        ...
        $.post("delTask.php", {
            ...
            $('#dsb_a').load('dashboardactions_onboard.php');
